<?php
/*
Template Name: szablon Restart-19
*/
...
<head>
    ...
    <title>Tarcza Restart 19 - Jak Wyjść z Długów</title>
...
<div id="main_div">
    ...
    <div id="top_div">
        ...
        <a href="https://tarczadlaciebie.pl/"><img alt="Tarcza dla Ciebie - Jak Wyjść z Długów - pomoc w zadłużeniach" id="top_logo" src="<?php bloginfo('template_directory'); ?>/images/logo4.png"></a>
	...
	<div id="main_page_picture_div" style="height: 550px; background-image:url('<?php bloginfo('template_directory'); ?>/images/slon.jpg')">	
		
		
<div>
<h3 style="text-align: center; font-size: 28px; color: #fff; text-shadow: 2px 2px #000;" class="show mobile">Pracujemy by Twój biznes wrócił na właściwe tory..</h3><br><h3 style="text-align: center; position: absolute; width: 100%; bottom: 0; color: #fff; text-shadow: 2px 2px #000;" class="show">Zostaw swój kontakt a nasz doradca prawny oddzwoni do Ciebie z propozycją KONKRETNYCH rozwiązań.</h3>
</div>		</div>		
...
<div id="stopka_div">
		...
		<div id="stopka_logo">
			<img alt="Tarcza dla Ciebie - pomoc w zadłużeniach" src="<?php bloginfo('template_directory'); ?>/images/logo_finance.png" width="160" height="130">
