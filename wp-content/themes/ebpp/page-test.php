...
<head>
    ...
    <title>Tarcza Prawna - Jak Wyjść z Długów | Oddłużanie | </title>
...
<div id="main_div">
    ...
    <div id="top_div">
        ...
        <a href="https://tarczadlaciebie.pl/"><img alt="EBBP - Jak Wyjść z Długów | Oddłużanie |  - pomoc w zadłużeniach" id="top_logo" src="<?php bloginfo('template_directory'); ?>/images/logo2.png"></a>
...
<div>
<h3 style="text-align: center; font-size: 28px; color: #fff; text-shadow: 2px 2px #000;" class="show">Darmowa pomoc prawna dla zadłużonych.</h3><br><h3 style="text-align: center; position: absolute; width: 100%; bottom: 0; color: #fff; text-shadow: 2px 2px #000;" class="show">Zostaw swój kontakt a nasz doradca prawny oddzwoni do Ciebie z propozycją KONKRETNYCH rozwiązań.</h3>
</div>		</div>		
...
<div id="top_bar_kontakt">
	<div id="inner_top_bar_kontakt">
		...
		<div id="formularz_button">
			...
			<a href="https://tarczadlaciebie/#form"><h3 class="tekst">FORMULARZ</h3></a>
		</div>
							...
							<div class="stopka_menu_group">
								<div class="stopka_menu_group_title">Warunki</div>
									<div class="stopka_menu_item">
										...
										<div class="stopka_menu_item">
											<a href="#regulamin">Regulamin serwisu</a></div>
										</div>
																
														
							<div class="stopka_menu_group">
							<div class="stopka_menu_group_title">Kontakt</div>
							<div><div class="stopka_menu_item"><a href="#kontakt">Telefon</a></div><div class="stopka_menu_item"><a href="#kontakt">E-mail</a></div><div class="stopka_menu_item"><a href="#kontakt">Konsultant ONLINE</a></div></div></div>							<div class="stopka_menu_group">
							<div class="stopka_menu_group_title">Społeczność</div>
							<div><div class="stopka_menu_item"><a target="blank" href="https://facebook.com">Facebook</a></div><div class="stopka_menu_item"><a target="blank" href="https://google.com">Google+</a></div><div class="stopka_menu_item"><a target="blank" href="#kontakt">Twiter</a></div></div></div></div>
		</center>
	</div>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KQPHR74"
