...
<div id="main_div">
    ...
    <div id="top_div">
        ...
        <a href="https://tarczadlaciebie.pl/"><img alt="Tarcza dla Ciebie - Jak Wyjść z Długów - pomoc w zadłużeniach" id="top_logo" src="<?php bloginfo('template_directory'); ?>/images/logo_finance.png"></a>
	...
	<div id="main_page_picture_div" style="height: 550px; background-image:url('<?php bloginfo('template_directory'); ?>/images/slider3.jpg')">	
		
		
<div>
<h3 style="text-align: center; font-size: 28px; color: #fff; text-shadow: 2px 2px #000;" class="show"></h3><br><h3 style="text-align: center; position: absolute; width: 100%; bottom: 0; color: #fff; text-shadow: 2px 2px #000;" class="show">Zostaw swój kontakt a nasz doradca prawny oddzwoni do Ciebie z propozycją KONKRETNYCH rozwiązań.</h3>
</div>		</div>		
