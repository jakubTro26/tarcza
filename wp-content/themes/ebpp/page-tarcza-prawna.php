...
<div id="main_div">
	...
	<div id="main_page_picture_div" style="height: 550px; background: #002f5d;">		
		<div class="top_napisy">
			<h3 style="text-align: left;letter-spacing: 1px; font-size: 28px; color: #fff; text-shadow: 2px 2px #000;" class="show mobile">Opieka prawna na najwyższym poziomie</h3>
